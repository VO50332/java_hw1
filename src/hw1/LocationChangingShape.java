...
public abstract class LocationChangingShape extends Shape implements Animatable {
     ...
     */
	 ...
	 private void checkRep() { 
	    ...
	    assert (this.velocityY <= 5 && this.velocityY >= -5) : "velocity in y direction cannot be higher than 5 or lower than -5";
	 }
    ...
    //	checkRep();
    	...
    	if ( velocityX > 5 || velocityX < -5 || velocityY > 5 || velocityY < -5 || velocityX == 0 || velocityY == 0) {
    		...
    		//System.out.println("vx is " + this.velocityX + ", vy is" +this.velocityY);
    		checkRep();
    	}
